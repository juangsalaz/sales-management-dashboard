    ...
    <div class="col-12">
        <div class="card">
            <div class="card-body">
                ...
                @endif
                {{ Form::open(['url' => '/admin/pengingat/store','class'=>'border p-3']) }}
                    <div class="form-row">
                        <div class="form-group col-md-4">
                            <label for="judul">Judul Pengingat <span class="text-danger">*</span></label>
                            {{ Form::text('judul', null,['class'=>'form-control','placeholder'=>'Ketik Judul Pengingat']) }}
                        </div>
                        <div class="form-group col-md-4">
                    ...
                    <div class="form-row">
                        <div class="form-group col-md-4">
                            ...
                            <input type="text" class="form-control tanggal-pengingat" name="tanggal" placeholder="Pilih Tanggal" />
                        </div>
                        ...
                        <div class="form-group col-md-4">
                            ...
                            <div class="form-group">
                                <div class="input-group date" id="datetimepicker3" data-target-input="nearest">
                                    <input type="text" class="form-control datetimepicker-input" name="jam" data-target="#datetimepicker3" placeholder="Pilih Jam"/>
