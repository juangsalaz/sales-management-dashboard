...
<div id="modal-hapus-permanen" class="modal fade" tabindex="-1" role="dialog" aria-labelledby="vcenter" aria-hidden="true">
            ...
            <div class="modal-body">
                ...
                <div class="row">
                    <div action="" class="m-auto">@csrf
                        ...
                        <input type="submit" class="btn btn-danger btn-delete-permanen-action" value="HAPUS">
                    </div>
                </div>
            </div>
        </div>
