    ...
    <div class="col-12">
        <div class="card">
            <div class="card-body">
                ...
                @endif
                {{ Form::open(['url' => '/admin/manajemen-marketing/real-sales/update/'.$data_real_sales[0]->id,'class'=>'border p-3 edit-form']) }}
                    <div class="form-row">
                        <div class="form-group col-md-4">
                            <label for="bulan">Pilih Bulan <span class="text-danger">*</span></label>
                            <input type="text" class="form-control datepicker" name="bulan" placeholder="Pilih Bulan" value="{{ date('F', strtotime($data_real_sales[0]->bulan)) }}" />
                        </div>
                        <div class="form-group col-md-4">
                            <label for="tahun">Pilih Tahun <span class="text-danger">*</span></label>
                            <input type="text" class="form-control yearpicker" name="tahun" placeholder="Pilih Tahun" value="{{ $data_real_sales[0]->tahun }}"/>
                        </div>
                        <div class="form-group col-md-4">
                            ...
                            <select name="user" id="estimasi-dm" class="form-control js-example-basic-single">
                                ...
                                @if ($jabatan_pengguna == 'Direktur' or $jabatan_pengguna == 'Superuser')
                                    @foreach ($data_dm as $dm)
                                        @if($data_real_sales[0]->nama_user == $dm->id)
                        ...
                        <div class="form-group col-md-4">
                            ...
                            <select name="coverage_area" id="estimasi-coverage-area2" class="form-control js-example-basic-single">
                                @foreach ($coverage_area_edit as $row)
                                    @if ($row->id == $data_real_sales[0]->coverage_area_id)
                        ...
                        <div class="form-group col-md-4">
                            ...
                            <select name="cabang" id="estimasi-cabang2" class="form-control js-example-basic-single">
                                @foreach ($cabangs as $cabang)
                                    @if ($cabang->id == $data_real_sales[0]->cabang_id)
                        ...
                        <div class="form-group col-md-4">
                            ...
                            <select name="distributor" id="estimasi-distributor2" class="form-control js-example-basic-single">
                                ...
                                @foreach ($distributors as $dist)
                                    @if ($dist->id == $data_real_sales[0]->distributor_id)
                    ...
                    <div class="form-row">
                        <div class="form-group col-md-4">
                            ...
                            <select name="outlet" class="form-control js-example-basic-single">
                                ...
                                @foreach($outlets as $outlet)
                                    @if ($outlet->id == $data_real_sales[0]->outlet)
                        ...
                        <div class="form-group col-md-4">
                            ...
                            <select name="produk" id="select-product" class="form-control js-example-basic-single" harga-produk="this.options[this.selectedIndex].getAttribute('isred')">
                                ...
                                @foreach($produks as $produk)
                                    @if($data_real_sales[0]->produk == $produk->id)
                        ...
                        <div class="form-group col-md-4">
                            ...
                            <div class="input-group mb-3">
                                ...
                                <input type="text" class="form-control input-no-dec" name="harga_produk" id="harga-produk" placeholder="Harga Produk" aria-label="Harga" aria-describedby="rp-harga" readonly value="{{ number_format($data_real_sales[0]->harga_produk,0,',','.') }}"/>
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="form-row">
                        <div class="form-group col-md-4">
                            ...
                            <input type="text" class="form-control input-no-dec" name="kuantiti" id="kuantiti-input" placeholder="Kuantiti" value="{{ $data_real_sales[0]->kuantiti }}"/>
                        </div>
                        <div class="form-group col-md-4">
                            ...
                            <div class="input-group mb-3">
                                ...
                                <input type="text" class="form-control input-no-dec" name="value_gross" id="value-gross" placeholder="Value Gross" aria-label="Value Gross" aria-describedby="rp-value-gross" readonly value="{{ number_format($data_real_sales[0]->value_gross,0,',','.') }}"/>
                            </div>
                        </div>
                        <div class="form-group col-md-4">
                            <label for="tahun">Diskon <span class="text-danger">*</span></label>
                            <div class="input-group mb-3">
                                <input type="text" class="form-control input-diskon" name="diskon" id="diskon-input" aria-label="Diskon" aria-describedby="persen-disokn" placeholder="Diskon" value="{{ $data_real_sales[0]->diskon }}"/>
                    ...
                    <div class="form-row">
                        <div class="form-group col-md-4">
                            ...
                            <div class="input-group mb-3">
                                ...
                                <input type="text" class="form-control input-no-dec" name="diskon_value" id="diskon-value" placeholder="Diskon Value" aria-label="Diskon Value" aria-describedby="rp-diskon-value" readonly value="{{ number_format($data_real_sales[0]->diskon_value,0,',','.') }}"/>
                            </div>
                        </div>
                        <div class="form-group col-md-4">
                            ...
                            <div class="input-group mb-3">
                                ...
                                <input type="text" class="form-control input-no-dec" name="value_nett" id="value-nett" placeholder="Value Nett" aria-label="Value Nett" aria-describedby="rp-value-nett" readonly value="{{ number_format($data_real_sales[0]->value_nett,0,',','.') }}"/>
                            </div>
                        </div>
                        <div class="form-group col-md-4">
                            <label for="tahun">Status <span class="text-danger">*</span></label>
                            <input type="text" class="form-control" name="status" placeholder="Status" value="Pengajuan" readonly value="{{ $data_real_sales[0]->status }}"/>
                        </div>
                    </div>
