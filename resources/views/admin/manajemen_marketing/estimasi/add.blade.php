    ...
    <div class="col-12">
        <div class="card">
            <div class="card-body">
                ...
                @endif
                {{ Form::open(['url' => '/admin/manajemen-marketing/estimasi/store','class'=>'border p-3']) }}
                    <div class="form-row">
                    ...
                    <div class="form-row">
                        <div class="form-group col-md-4">
                            ...
                            {{-- test autonumber --}}
                            {{-- <input type="text" data-a-pad="false" data-a-dec="," data-a-sep="." name="kuantiti" id="kuantiti-input" class="autonumber form-control"> --}}
                        </div>
                        <div class="form-group col-md-4">
